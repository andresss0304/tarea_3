...
## Tabla de riqueza de orquideas en areas de conservacion
```{r}
...
## Maoa de riqueza de especies de orquideas en areas de conservación
```{r}
#| label: mapa-riqueza
#| warning: false
#| message: false
...
## Grafico de barras de riqueza de especies de orquídeas en areas de conservación
```{r}
